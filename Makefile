...
test-bench: generate fmt vet manifests api-docs download-crd-deps install-envtest
	KUBEBUILDER_ASSETS=$(KUBEBUILDER_ASSETS) go test ./controllers/... -run=XXX -bench=. -benchmem -benchtime=1000x -v -coverprofile cover.out
